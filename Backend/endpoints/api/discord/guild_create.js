...
async function handle(payload) {
  ...
  if (new Date(payload.joined_at).getTime() >= Date.now() - 1000 * 10) {
    ...
    if (guild.system_channel_id) {
      ...
      await discord.post(guild.system_channel_id, `Hi, I'm <@${me.id}>. I can play music, tell jokes, schedule weekly events, whatever you need. Type \'<@${me.id}> help\' to learn how to talk to me. I'm always around and happy to help.`);
    }
  } else {
